...
export function HeroSearch() {
  ...
  return (
    <div className="relative z-20 mx-auto w-full max-w-[1200px] px-4 sm:px-6 lg:px-8">
      <div className="rounded-2xl bg-white p-4 shadow-[0_12px_40px_rgb(12_35_64/0.18)] sm:p-5 md:p-6">
        <div className="mb-4 flex flex-wrap gap-x-8 gap-y-2 border-b border-[#e6ebf2]">
          <button
            type="button"
            onClick={() => setTab("acheter")}
            className={cn(
              "relative pb-3 text-sm font-semibold transition-colors sm:text-[15px]",
        ...
        {tab === "acheter" ? (
          ...
          >
            <label className="block">
              ...
              <input
                ...
                className="h-12 w-full rounded-lg border border-[#d5dde8] bg-white px-3.5 text-[15px] text-navy outline-none placeholder:text-[#9aa8ba] focus:border-orange focus:ring-2 focus:ring-orange/25"
              />
            </label>
            <label className="block">
              ...
              <select
                ...
                className="h-12 w-full appearance-none rounded-lg border border-[#d5dde8] bg-white bg-[length:12px] bg-[right_12px_center] bg-no-repeat px-3.5 pr-9 text-[15px] text-navy outline-none focus:border-orange focus:ring-2 focus:ring-orange/25"
                style={{
                  backgroundImage:
            ...
            <button
              type="submit"
              className="inline-flex h-12 items-center justify-center gap-2 rounded-lg bg-orange px-6 text-[15px] font-bold text-white transition-colors hover:bg-[#e05f00] md:min-w-[160px]"
            >
          ...
          <div className="flex flex-col items-start justify-between gap-4 sm:flex-row sm:items-center">
            <p className="max-w-xl text-[15px] leading-relaxed text-[#5a6b80]">
            ...
            <button
              ...
              className="inline-flex h-12 items-center justify-center gap-2 rounded-lg bg-orange px-6 text-[15px] font-bold text-white transition-colors hover:bg-[#e05f00]"
            >
              Estimer ma reprise
            </button>
          </div>
